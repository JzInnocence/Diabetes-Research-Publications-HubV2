...
<body>
    <?php
        ...
        include ('database/requestCertainRelationship.php');
    ...
    ?>
        ...
        <section class = "intro">
            ...
            <div class="content">
                ...
                <Form class = "form-search" style = "margin-left:0" method = "post" action = "certainAuthor.php">
                        ...
                        <div class= "col-sm-r", style = "fill : #FFFFFF" >
                            <table class="table" bgcolor="#FFFFFF">
                                <tbody text = "black"; bgcolor="#FFFFFF">
                                    <?php
                                        include("database/requestCertainPulications.php");
